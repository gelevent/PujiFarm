...
<body class="bg-gradient-to-br from-emerald-50 via-white to-teal-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-10 right-1/4 w-72 h-72 bg-teal-200/30 rounded-full blur-3xl animate-float"
            style="animation-delay: 1.5s;"></div>
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-100/20 rounded-full blur-3xl">
        </div>
    </div>
    ...
    <div class="relative w-full max-w-md fade-in">
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div class="px-8 pt-10 pb-6 text-center">
                <!-- Logo -->
                <div
                    class="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl mb-5 shadow-lg shadow-emerald-500/25">
                ...
                <form action="{{ route('login.process') }}" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-xl text-sm 
                                ...
                                placeholder="admin@pujifarm.com" required autofocus>
                        </div>
                        @error('email')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg">🔐</span>
                            <input type="password" id="password" name="password" class="w-full pl-11 pr-12 py-3.5 border border-gray-200 rounded-xl text-sm 
                                       bg-gray-50/50 focus:bg-white
                                       focus:outline-none input-focus focus:border-emerald-500 
                                       transition-all duration-200
                                       @error('password') border-red-300 bg-red-50/50 @enderror" placeholder="••••••••"
                                required>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white 
        ...
        <div class="text-center mt-6">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-1.5 text-gray-500 hover:text-emerald-600 
