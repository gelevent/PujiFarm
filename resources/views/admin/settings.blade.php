...
<body class="bg-gray-50 min-h-screen antialiased">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex items-center gap-2 text-lg sm:text-xl font-bold text-gray-900 hover:text-emerald-600 transition-colors">
                    <span class="text-emerald-600">⚡</span> <span class="hidden sm:inline">PujiFarm Admin</span><span class="sm:hidden">Admin</span>
                </a>
    ...
    <main class="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6">
        ...
        <div class="w-full fade-in-up" style="animation-delay: 0.1s;">
            ...
            <!-- Notifikasi Success -->
            @if(session('success'))
                <div class="bg-green-50 border border-green-200 text-green-800 px-4 py-3.5 rounded-xl mb-5 flex items-center gap-3 fade-in-up" role="alert">
            ...
            <div class="bg-white shadow-sm rounded-2xl p-5 sm:p-7 border border-gray-200 card-hover">
                ...
                <div class="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100">
                    <div class="w-11 h-11 sm:w-12 sm:h-12 bg-green-100 rounded-xl flex items-center justify-center text-xl sm:text-2xl flex-shrink-0">
                        💬
                    </div>
                    <div class="min-w-0">
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                pattern="^[0-9]+$"
                                title="Hanya angka, format internasional (contoh: 628123456789)"
                                required
                                inputmode="numeric"
                            >
                        </div>
                    ...
                    <div class="mb-6 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                        ...
                        <code id="waPreview" class="block text-xs text-emerald-700 break-all bg-white px-3 py-2.5 rounded-lg border border-emerald-200 font-mono">
            ...
            <div class="mt-5 p-4 bg-blue-50 rounded-xl border border-blue-100 fade-in-up" style="animation-delay: 0.2s;">
    ...
    <footer class="border-t border-gray-200 py-5 mt-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center text-xs text-gray-400">
            ...
            <a href="{{ route('home') }}" target="_blank" class="sm:hidden text-emerald-600 hover:text-emerald-700">Kembali ke Web</a>
        </div>
    </footer>
