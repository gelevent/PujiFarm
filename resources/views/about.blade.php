...
<body class="bg-gray-50 text-gray-800 antialiased">
    ...
    <header class="bg-gradient-to-br from-emerald-600 to-teal-700 text-white py-20 sm:py-28">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute bottom-10 right-10 w-72 h-72 bg-emerald-300/20 rounded-full blur-3xl animate-float"
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                ...
                <div class="lg:w-1/2 w-full fade-in-up">
                    <div class="relative">
                        <div
                            class="bg-gradient-to-br from-emerald-100 to-blue-100 rounded-3xl p-8 sm:p-10 h-72 sm:h-80 flex items-center justify-center card-hover border border-gray-100">
                            <div class="text-center">
                                <div class="text-7xl sm:text-8xl mb-4 animate-float">🏡</div>
                                <p class="text-gray-700 font-semibold text-sm sm:text-base">Usaha Keluarga Sejak 1999
                                </p>
                            </div>
                        </div>
                        ...
                        <!-- Floating Badge -->
                        <div
                            class="absolute -bottom-4 -right-4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 card-hover">
                ...
                <div class="lg:w-1/2 w-full fade-in-up" style="animation-delay: 0.1s;">
                    <span
                        class="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 text-xs font-semibold rounded-full mb-5">
                        Cerita Kami
                    </span>
                    ...
                    <div class="space-y-4 text-gray-600 leading-relaxed">
                        ...
                        <p class="text-sm sm:text-base">
                            Kami memiliki <strong class="text-gray-800">kandang sendiri</strong> yang dikelola secara
                            langsung,
                            sehingga setiap proses pemeliharaan dapat terkontrol dengan baik dan memastikan kondisi
                            ternak tetap optimal.
                        </p>
                        <p class="text-sm sm:text-base">
                            Selain itu, kami juga menggunakan <strong class="text-gray-800">pakan mandiri</strong> yang
        ...
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div class="bg-gray-50 rounded-2xl p-6 text-center card-hover fade-in-up group">
                    <div
                        class="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4 group-hover:scale-110 transition-transform">
                        ✅
                    </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-6 text-center card-hover fade-in-up group"
                    ...
                    <div
                        class="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4 group-hover:scale-110 transition-transform">
                        🌿
                    </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-6 text-center card-hover fade-in-up group"
                    ...
                    <div
                        class="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4 group-hover:scale-110 transition-transform">
                        🚀
                    </div>
            ...
            <div class="max-w-4xl mx-auto fade-in-up">
                <div class="rounded-2xl overflow-hidden border border-gray-200 shadow-sm card-hover">
                    <iframe
                        ...
                        referrerpolicy="no-referrer-when-downgrade" title="Lokasi PujiFarm">
                    </iframe>
                </div>
