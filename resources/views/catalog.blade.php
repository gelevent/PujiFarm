            ...
            <div class="max-w-3xl mx-auto">
                <div class="relative">
                    ...
                    <input 
                        type="text" 
                        id="searchInput" 
                        placeholder="Cari produk, misalnya: ayam, telur, pakan..." 
                ...
                @foreach($items as $index => $item)
                    <div class="product-card group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 
                        ...
                        <div class="overflow-hidden h-44 sm:h-52 bg-gray-100 relative">
                            ...
                            @else
                                <div class="w-full h-full flex items-center justify-center text-4xl sm:text-5xl text-gray-300 bg-gradient-to-br from-emerald-50/50 to-blue-50/50">
                                    📦
                                </div>
                            @endif
                            ...
                            @if($item->is_highlight)
                                <span class="absolute top-3 left-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white 
                        ...
                        <div class="p-4 sm:p-5 flex flex-col">
                            <!-- Product Name -->
                            <h3 class="font-bold text-base sm:text-lg text-gray-900 mb-1.5 group-hover:text-emerald-600 transition-colors line-clamp-1">
                                {{ $item->name }}
                            </h3>
        ...
        <div class="container mx-auto px-4 sm:px-6 text-center fade-in-up">
            <div class="max-w-2xl mx-auto">
                ...
                <a href="https://wa.me/{{ $waNumber }}?text=Halo PujiFarm, saya butuh bantuan memilih produk" 
                   target="_blank"
                   class="inline-flex items-center gap-2 bg-white text-emerald-600 font-semibold px-6 py-3 rounded-xl 
